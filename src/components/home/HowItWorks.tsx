    ...
    <section id="how-it-works" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Connector line */}
          <div className="hidden lg:block absolute top-24 left-1/2 -translate-x-1/2 w-2/3 h-0.5 bg-slate-100 z-0" />
        ...
        <div className="mt-16 text-center">
          <a
            href="/search"
            className="inline-flex items-center gap-2 gradient-bg text-white font-bold px-10 py-4 rounded-xl shadow-lg hover:shadow-xl hover:bg-blue-700 transition-all text-lg"
          >
