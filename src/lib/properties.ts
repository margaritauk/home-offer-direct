...
export const ALL_PROPERTIES: Property[] = [
  {
    ...
    photos: ["https://picsum.photos/id/10/800/600"],
    type: "Single Family",
  ...
  },
  {
    ...
    photos: ["https://picsum.photos/id/29/800/600"],
    type: "Townhouse",
    priceHistory: "same",
    priceChange: 0,
    aiScore: 72,
  ...
  },
  {
    ...
    brokerage: "Compass",
    img: "https://picsum.photos/id/67/600/400",
    photos: ["https://picsum.photos/id/67/800/600"],
    type: "Single Family",
  ...
  },
  {
    ...
    photos: ["https://picsum.photos/id/164/800/600"],
    type: "Single Family",
    priceHistory: "same",
    priceChange: 0,
    aiScore: 78,
