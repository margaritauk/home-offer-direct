...
const sampleProperties = [
  {
    ...
    aiScore: 87,
    aiLabel: "Great Value",
    aiColor: "text-emerald-600 bg-emerald-50",
  ...
  },
  {
    ...
    aiScore: 72,
    aiLabel: "Competitive",
    aiColor: "text-blue-600 bg-blue-50",
  ...
  },
  {
    ...
    aiScore: 91,
    aiLabel: "Best Deal",
    aiColor: "text-purple-600 bg-purple-50",
  ...
  },
  {
    ...
    aiScore: 65,
    aiLabel: "Act Fast",
    aiColor: "text-orange-600 bg-orange-50",
    suggestedOffer: [545000, 565000],
    marketTrend: "hot",
    listingAgent: "Thomas Burke",
  ...
  },
  {
    ...
    aiScore: 95,
    aiLabel: "Negotiation Opportunity",
    aiColor: "text-green-600 bg-green-50",
    suggestedOffer: [210000, 225000],
    marketTrend: "cooling",
    listingAgent: "Patricia Williams",
  ...
  },
  {
    ...
    marketTrend: "hot",
    listingAgent: "Jennifer Davis",
    brokerage: "Jameson Sotheby's",
  },
];
      ...
      <div className="bg-white border-b border-slate-200 pt-20 pb-4 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-2 mt-3 flex-wrap">
            ...
            <button className="px-4 py-1.5 rounded-full text-xs font-medium bg-white border border-slate-200 text-slate-600 hover:border-blue-300 transition-all">
              No HOA
            </button>
            <button className="px-4 py-1.5 rounded-full text-xs font-medium bg-white border border-slate-200 text-slate-600 hover:border-blue-300 transition-all">
              Price Reduced
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-bold text-slate-900">
              {sampleProperties.length} homes for sale in Chicago, IL
            </h1>
    ...
    <div className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 group">
      ...
      <div className="relative h-52 bg-slate-100 overflow-hidden">
        ...
        <div className={`absolute top-3 left-3 flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold ${property.aiColor} backdrop-blur-sm`}>
          ...
          {property.aiScore} · {property.aiLabel}
        </div>
        ...
        <button
          ...
          className={`absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center transition-all ${
            saved ? "bg-red-500 text-white" : "bg-white/90 text-slate-600 hover:bg-white"
          }`}
        >
        ...
        {property.marketTrend === "hot" && (
          <div className="absolute bottom-3 right-3 bg-red-500 text-white text-xs px-2 py-1 rounded-lg font-semibold">
            🔥 Hot Market
          </div>
        )}
      </div>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-4 text-sm text-slate-600 mb-4 pb-4 border-b border-slate-100">
          <div className="flex items-center gap-1">
            ...
            <span className="text-slate-400 text-xs">bd</span>
          </div>
          <div className="flex items-center gap-1">
            <Bath className="w-4 h-4 text-slate-400" />
            <span className="font-medium">{property.baths}</span>
            <span className="text-slate-400 text-xs">ba</span>
          </div>
          <div className="flex items-center gap-1">
            <Square className="w-4 h-4 text-slate-400" />
            <span className="font-medium">{property.sqft.toLocaleString()}</span>
            <span className="text-slate-400 text-xs">sqft</span>
          </div>
          {property.hoa > 0 && (
